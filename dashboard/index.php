...
$billingStaticCopy = $partnerPreferences['language'] === 'id'
    ? [
        'kicker' => 'Tagihan minggu kalender',
        'title' => 'Senin sampai Minggu, rekonsiliasi jelas',
        ...
        'confirmed_bills' => 'Semua tagihan minggu kalender yang dikonfirmasi',
        'loading' => 'Memuat tagihan minggu kalender…',
        'detail_title' => 'Rincian tagihan Anda akan muncul di sini',
        'detail_copy' => 'Pilih periode minggu kalender untuk melihat setiap pesanan yang termasuk.',
    ]
    : [
        'kicker' => 'Calendar-week billing',
        'title' => 'Monday to Sunday, clearly reconciled',
        ...
        'confirmed_bills' => 'All confirmed calendar-week bills',
        'loading' => 'Loading calendar-week bills…',
        'detail_title' => 'Your bill details will appear here',
        'detail_copy' => 'Select a calendar-week period to see every included order.',
    ];
...
<body class="admin-body is-dashboard">
    <div class="admin-build-badge" aria-label="Partner portal build version">Build 1.03.03</div>
    <div
    ...
    <div class="admin-modal-shell partner-billing-tutorial" data-billing-tutorial hidden>
        ...
        <section class="admin-modal-card partner-billing-tutorial-card" role="dialog" aria-modal="true" aria-labelledby="billing-tutorial-title" tabindex="-1">
            ...
            <span class="partner-panel-kicker" data-billing-tutorial-kicker>Calendar-week billing</span>
            ...
            <p data-billing-tutorial-copy>Every bill covers one Monday–Sunday calendar week and includes a transparent order-by-order breakdown.</p>
